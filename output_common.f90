...
subroutine output(dir, iBlock, iOutputType)
  ...
  case ('3DALL')
     ...
     nvars_to_write = 13+nSpeciesTotal+nSpecies+nIons &
          ...
          +3 & ! (ExB drift)
          +2 + 1 & ! (TEC, int-JH, Jwd)
          +6 & ! (Jp1, Jp1UcB, Jp1EF also for '2'; follow Cheng, yuhong on 020524)
          +6 & ! (J3D & J2D)
          +6 & ! (J2DUcB, J2DUcB)
          +6 ! (J3DEF & J2DEF)
  ...
  subroutine output_header
    ...
    if (cType(3:5) == "ALL" .or. cType(3:5) == "ION") then
       ...
       if (cType(3:5) == "ALL") then
          ...
          !---------------------------------------------------------------
          write(iOutputUnit_,"(I7,A1,a)") iOff+1, " ", "Jp1"
          write(iOutputUnit_,"(I7,A1,a)") iOff+2, " ", "Jp2"
          write(iOutputUnit_,"(I7,A1,a)") iOff+3, " ", "Jp1_UcrossB"
          write(iOutputUnit_,"(I7,A1,a)") iOff+4, " ", "Jp2_UcrossB"
          write(iOutputUnit_,"(I7,A1,a)") iOff+5, " ", "Jp1_EField"
          write(iOutputUnit_,"(I7,A1,a)") iOff+6, " ", "Jp2_EField"

          iOff = iOff + 6

          !---------------------------------------------------------------
          !         ==>    now add 3D & 2D variables
          !---------------------------------------------------------------
          write(iOutputUnit_,"(I7,A1,a)") iOff+1, " ", "J3D (east)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+2, " ", "J3D (north)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+3, " ", "J3D (up)"

          iOff = iOff + 3

          write(iOutputUnit_,"(I7,A1,a)") iOff+1, " ", "J2D (east)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+2, " ", "J2D (north)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+3, " ", "J2D (up)"

          iOff = iOff + 3

          write(iOutputUnit_,"(I7,A1,a)") iOff+1, " ", "J3D_UcrossB (east)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+2, " ", "J3D_UcrossB (north)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+3, " ", "J3D_UcrossB (up)"

          iOff = iOff + 3

          write(iOutputUnit_,"(I7,A1,a)") iOff+1, " ", "J2D_UcrossB (east)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+2, " ", "J2D_UcrossB (north)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+3, " ", "J2D_UcrossB (up)"

          iOff = iOff + 3

          write(iOutputUnit_,"(I7,A1,a)") iOff+1, " ", "J3D_EField (east)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+2, " ", "J3D_EField (north)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+3, " ", "J3D_EField (up)"

          iOff = iOff + 3

          write(iOutputUnit_,"(I7,A1,a)") iOff+1, " ", "J2D_EField (east)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+2, " ", "J2D_EField (north)"
          write(iOutputUnit_,"(I7,A1,a)") iOff+3, " ", "J2D_EField (up)"
     ...
     do iLat=-1,nLats+2
        ...
        do iLon=-1,nLons+2
           ...
           write(iOutputUnit_)       &
                ...
                Jp1EF(iiLon,iiLat), &
                Jp2EF(iiLon,iiLat), &
                (J3D(iiLon,iiLat,iiAlt,i),i=1,3), &
                (J2D(iiLon,iiLat,i),i=1,3), &
                (J3DUcB(iiLon,iiLat,iiAlt,i),i=1,3), &
                (J2DUcB(iiLon,iiLat,i),i=1,3), &
                (J3DEF(iiLon,iiLat,iiAlt,i),i=1,3), &
